...
namespace UnitTest1
{
    ...
    public class UnitTest1
    {
        ...
        public void IndependetCharJoinTest()
        {
            ...
            {
                new Infantry(100,150,4,4,3,3,5,9,4,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{new baldestorm()})},new List<EffectsModel>{}),
                new Infantry(100,200,4,4,3,3,5,9,4,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{new baldestorm()})},new List<EffectsModel>{}),
                new Infantry(100,250,4,4,3,3,5,9,4,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{new baldestorm()})},new List<EffectsModel>{}),
                new Infantry(100,300,4,4,3,3,5,9,4,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{new baldestorm()})},new List<EffectsModel>{}),
                new Infantry(100,350,4,4,3,3,5,9,4,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{new baldestorm()})},new List<EffectsModel>{}),
                new Infantry(100,400,5,5,3,3,5,9,4,7,new List<Weapon>{new Pistol(4,5,new List<EffectsWeapons>{new baldestorm()})},new List<EffectsModel>{})
            };
            List<BasicModel> Terminators = new List<BasicModel>
            {
                new Infantry(200,150,4,4,4,4,5,9,2,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{})},new List<EffectsModel>{}),
                new Infantry(200,200,4,4,4,4,5,9,2,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{})},new List<EffectsModel>{}),
                new Infantry(200,250,4,4,4,4,5,9,2,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{})},new List<EffectsModel>{}),
                new Infantry(200,300,4,4,4,4,5,9,2,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{})},new List<EffectsModel>{}),
                new Infantry(200,350,4,4,4,4,5,9,2,7,new List<Weapon>{new Assault(4,5,2,new List<EffectsWeapons>{})},new List<EffectsModel>{}),
            };
            List<BasicModel> TerminatorLeader = new List<BasicModel>
            {
               new Infantry(200,400,5,5,4,4,5,9,2,7,new List<Weapon>{new Pistol(4,5,new List<EffectsWeapons> { new baldestorm() }) }, new List<EffectsModel> { new Fearless(), new IndependetCharecter()})
            };
